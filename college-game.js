document.addEventListener("DOMContentLoaded", () => {
  ...
  let slides = Array.from(document.querySelectorAll(".game-slide"));
  const prevBtn = document.querySelector(".game-prev");
  const nextBtn = document.querySelector(".game-next");

  // pafo用の取得
  const frontSection = document.getElementById("game-front");
  const backSection = document.getElementById("game-back");
