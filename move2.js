document.addEventListener("DOMContentLoaded", () => {
  ...
  const frontSection = document.getElementById("sample-front");
  const backSection = document.getElementById("sample-back");
  const openBtn = document.getElementById("open-sample-btn");

  const closeBtn = document.getElementById("close-sample-btn");
